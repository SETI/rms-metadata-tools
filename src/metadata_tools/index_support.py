...
import metadata_tools.index_formats as index_formats
...
class IndexTable(com.Table):
    ...
    def __init__(self, input_dir=None, output_dir=None, template_path=None, metadata_dir=None,
        ...
        self.column_stubs = index_formats._get_column_values(pds3_table)
    ...
    def add(self, root, name):
        ...
        for column_stub in self.column_stubs:
            ...
            fvalue = index_formats._format_column(column_stub, value)
            line += fvalue
