...
# or gcp_geometry_startup.tail.sh instead of modifying this file directly.
...
metadata-geometry GO_0xxx \
                gs://rms-node-holdings/pds3-holdings/metadata/GO_0xxx/ \
                gs://rms-metadata-jspitale/metadata_test/GO_0xxx/ -vv GO_0022 --num-simultaneous-tasks 1
COMMENT_BLOCK
