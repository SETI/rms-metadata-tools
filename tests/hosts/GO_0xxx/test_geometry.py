...
#            unit.bounds(file, table, 'SUB_SOLAR_PLANETOCENTRIC_LATITUDE',
#                        min_val=-30, max_val=30)
#            unit.bounds(file, table, 'SUB_SOLAR_PLANETOGRAPHIC_LATITUDE',
#                        min_val=-30, max_val=30)
#            unit.bounds(file, table, 'SUB_OBSERVER_PLANETOCENTRIC_LATITUDE',
#                        min_val=-35, max_val=35)
#            unit.bounds(file, table, 'SUB_OBSERVER_PLANETOGRAPHIC_LATITUDE',
#                        min_val=-35, max_val=35)
...
def test_geometry_ring() -> None:
    ...
    for file in files:
        ...
        # validate value bounds
        unit.bounds(file, table, 'NORTH_BASED_INCIDENCE_ANGLE',
                    min_val=35, max_val=145)
        unit.bounds(file, table, 'SOLAR_RING_ELEVATION', min_val=-35, max_val=35)
        unit.bounds(file, table, 'RING_CENTER_INCIDENCE_ANGLE', min_val=60, max_val=90)
        unit.bounds(file, table, 'NORTH_BASED_CENTER_INCIDENCE_ANGLE',
                    min_val=35, max_val=145)

        #################### Slightly exceeds 90 deg in GO_0022
#            unit.bounds(file, table, 'RING_CENTER_EMISSION_ANGLE', min_val=-30, max_val=30)
