...
# get_index_name
#===============================================================================
def test_get_index_name_with_type():
    name = util.get_index_name(FCPath('/x/GO_0001'), 'GO_0001', 'supplemental')
    assert name == 'GO_0001_supplemental_index'


def test_get_index_name_without_type():
    name = util.get_index_name(FCPath('/x/GO_0001'), 'GO_0001', None)
...
# get_template_name
#===============================================================================
def test_get_template_name_substitutes_collection():
...
# parse_template_name
#===============================================================================
def test_parse_template_name_splits_host_and_type():
...
def test_parse_template_name_preserves_host_underscores():
...
#===============================================================================
def test_splitpath_splits_around_string():
...
def test_get_volume_subdir_returns_relative_tail():
...
# get_volume_glob
#===============================================================================
def test_get_volume_glob_expands_x_digits():
    assert util.get_volume_glob('GO_0xxx') == 'GO_0[0-9][0-9][0-9]'


def test_get_volume_glob_only_last_segment():
...
# get_observation_id
#===============================================================================
def test_get_observation_id_reads_subfields():
